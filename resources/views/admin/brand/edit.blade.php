                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal p-t-20" action="{{ route('brand.update', ['id' => $brand->id]) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <label class="me-3"><input type="radio"{{ $brand->status == 1 ? 'checked' : '' }}
                                        name="status" value="1" checked>Published</label>
                                <label><input type="radio" {{ $brand->status == 2 ? 'checked' : '' }} name="status"
                                        value="2">UnPublished</label>
                            </div>
                        </div>
                        <div class="form-group row m-b-0">
                            <div class="offset-sm-3 col-sm-9">
                                <button type="submit" class="text-white btn btn-success waves-effect waves-light">Update
                                    Brand Info
                                </button>
                            </div>
                        </div>
