                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mailbox animated bounceInDown">
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="javascript:void(0)">
                                                <div class="text-white btn btn-danger btn-circle"><i
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="text-white btn btn-success btn-circle"><i
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="text-white btn btn-info btn-circle"><i
                                    ...
                                    <li>
                                        <a class="text-center nav-link link" href="javascript:void(0);"> <strong>Check
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox dropdown-menu-end animated bounceInDown"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="text-center nav-link link" href="javascript:void(0);"> <strong>See
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><i class="icon-speedometer"></i><span
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><i class="ti-palette"></i><span class="hide-menu">Ui Elements
                                    <span class="text-white badge rounded-pill bg-primary ms-auto">25</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><i class="ti-files"></i><span class="hide-menu">Sample Pages
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><i class="ti-align-left"></i><span class="hide-menu">Multi
                                    level dd</span></a>
                            <ul aria-expanded="false" class="collapse">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button type="button" class="text-white btn btn-info d-none d-lg-block m-l-15"><i
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="row">
                            <!-- Column -->
                            <div class="col-md-12">
                                <div class="text-white card bg-cyan">
                                    <div class="card-body ">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="row">
                            ...
                            <!-- Column -->
                            <div class="col-md-12">
                                <div class="text-white card bg-purple">
                                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <button class="text-white pull-right btn btn-circle btn-success"
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            <div class="form-check d-flex align-items-start">
                                                <input type="checkbox" class="flex-shrink-0 form-check-input"
                                                    id="customCheck">
                                                <label
                                                    class="font-normal form-check-label w-100 ms-2 d-md-flex align-items-start lh-25"
                                                    for="customCheck">
                                                    <span>Lorem Ipsum is simply dummy text of the printing and
                                                        typesetting industry. Lorem Ipsum has been</span> <span
                                                        class="mb-2 badge rounded-pill bg-danger ms-auto mb-md-0">Today</span>
                                                </label>
                                            </div>
                                            <ul class="mt-2 assignedto">
                                                <li><img src="{{ asset('admin/assets') }}/images/users/1.jpg"
                                                        alt="user" data-bs-toggle="tooltip" data-placement="top"
                                                        title="" data-original-title="Steave"></li>
                                                <li><img src="{{ asset('admin/assets') }}/images/users/2.jpg"
                                                        alt="user" data-bs-toggle="tooltip"
                                                        data-placement="top" title=""
                                                        data-original-title="Jessica"></li>
                                                <li><img src="{{ asset('admin/assets') }}/images/users/3.jpg"
                                                        alt="user" data-bs-toggle="tooltip"
                                                        data-placement="top" title=""
                                                        data-original-title="Priyanka"></li>
                                                <li><img src="{{ asset('admin/assets') }}/images/users/4.jpg"
                                                        alt="user" data-bs-toggle="tooltip"
                                                        data-placement="top" title=""
                                            ...
                                            <div class="form-check d-flex align-items-start">
                                                ...
                                                <label
                                                    ...
                                                    <span>Lorem Ipsum is simply dummy text of the printing</span><span
                                                        class="mb-2 badge rounded-pill bg-primary ms-auto mb-md-0">1
                                                        week </span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check d-flex align-items-start">
                                                ...
                                                <label
                                                    ...
                                                    <span>Give Purchase report to</span> <span
                                                        class="mb-2 badge rounded-pill bg-info ms-auto mb-md-0">Yesterday</span>
                                                </label>
                                            </div>
                                            <ul class="assignedto">
                                                <li><img src="{{ asset('admin/assets') }}/images/users/3.jpg"
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            <div class="form-check d-flex align-items-start">
                                                ...
                                                <label
                                                    ...
                                                    for="customCheck1">
                                                    <span>Lorem Ipsum is simply dummy text of the printing</span><span
                                                        class="mb-2 badge rounded-pill bg-warning ms-auto mb-md-0">2
                                                        week </span>
                                                </label>
                                            </div>
                                            <div class="item-date"> 26 jun 2017</div>
                                    ...
                                    <div class="message-widget message-scroll">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img
                                                    ...
                                                    class="profile-status online pull-right"></span> </div>
                                            <div class="mail-contnet">
                                                <h5>Pavan kumar</h5> <span class="mail-desc">Lorem Ipsum is simply
                                                    dummy text of the printing and type setting industry. Lorem Ipsum
                                                    has been.</span> <span class="time">9:30 AM</span>
                                            </div>
                                        </a>
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body border-top">
                                <div class="row">
                                    <div class="col-8">
                                        <textarea placeholder="Type your message here" class="border-0 form-control"></textarea>
                                    </div>
                                    <div class="col-4 text-end">
                                        <button type="button" class="text-white btn btn-info btn-circle btn-lg"><i
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('admin/assets') }}/images/users/2.jpg" alt="user-img"
                                            class="img-circle"> <span>Genelia Deshmukh <small
                                                class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('admin/assets') }}/images/users/3.jpg" alt="user-img"
                                            class="img-circle"> <span>Ritesh Deshmukh <small
                                                class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('admin/assets') }}/images/users/4.jpg" alt="user-img"
                                            class="img-circle"> <span>Arijit Sinh <small
                                                class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('admin/assets') }}/images/users/5.jpg" alt="user-img"
                                            class="img-circle"> <span>Govinda Star <small
                                                class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('admin/assets') }}/images/users/6.jpg" alt="user-img"
                                            class="img-circle"> <span>John Abraham<small
                                                class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('admin/assets') }}/images/users/7.jpg" alt="user-img"
                                            class="img-circle"> <span>Hritik Roshan<small
                                                class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('admin/assets') }}/images/users/8.jpg" alt="user-img"
